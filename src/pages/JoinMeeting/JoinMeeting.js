	      	...
	      	<View style={styles.card} >
		        ...
		        <View style={{ marginTop: 12, marginBottom: 42 }} >
		        	<View style={styles.setting}>
		        		...
		        		<TouchableOpacity  activeOpacity={0.9} onPress={() => setCamera(!camera)}>
		        			<Image source={ camera ? onSwitch :offSwitch} style={styles.switch} />
		        		</TouchableOpacity>
		        	</View>

			        <View style={{...styles.setting, marginTop: 18 }}>
			        	<Text style={styles.text}>{t('DontConnectAudio')}</Text>
			        	<TouchableOpacity  activeOpacity={0.9} onPress={() => setAudio(!audio)}>
		        			<Image source={ audio ? onSwitch :offSwitch} style={styles.switch} />
		        		</TouchableOpacity>
			        </View>
		        </View>
